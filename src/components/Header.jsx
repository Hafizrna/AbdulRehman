...
const Header = () => {
  ...
  I design and develop stunning, high-performance websites using <span className="text-blue-400 font-semibold">React.js</span> and <span className="text-blue-400 font-semibold">Tailwind CSS</span> turning ideas into interactive digital experiences.
</p>
