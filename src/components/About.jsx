...
const About = () => {
    return (
        <motion.div
            ...
            <p className='text-gray-500 max-w-80 text-center mb-8'>Dreaming big, working smart, and staying humble.</p>
            <div className='flex flex-col md:flex-row items-center md:items-start md:gap-5'>
                ...
                <div className='flex flex-col items-center md:items-center mt-10 text-gray-600'>
                    ...
                    <button className='bg-blue-500 hover:bg-blue-600 text-white py-2 px-12 mb-10 rounded transition-colors duration-200'><a href="https://www.linkedin.com/in/abdulrehman-nadeem/" target="_blank" rel="noopener noreferrer">Know More</a></button>
                </div>
            </div>
        </motion.div>
    )
